...
const notifications = [
  ...
  },
  {
    ...
    message: "La Asociación Solidarista {{ financeEntityName }} ha aprobado el crédito por un monto de {{ Amount }} para el procedimiento {{ procedureName }} / producto {{ productName }}. Por favor revisá el documento de pagaré.\n\nCódigo: {{ creditCode }}\n\nTotal a pagar restante: {{ totalProcedure }}",
    another_message: "La Asociación Solidarista {{ financeEntityName }} ha aprobado el crédito por un monto de {{ Amount }} para el procedimiento {{ procedureName }} / producto {{ productName }}.",
    required_send_email: true,
    text_from_email_message_json: true,
    email_template: "genericTemplateButtonEmail",
    action_url: "https://vitalkink.cr/pacientes/citas",

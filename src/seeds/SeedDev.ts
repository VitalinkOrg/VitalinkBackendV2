        ...
        const financeEntities = [
          {
            ...
            email: "fabian7593+bancofinanciero@gmail.com",
        ...
        const legalRepresentatives = [
          {
            ...
            name: "Gabriela Ulate",
            email: "fabian7593+gulate@gmail.com",
            user_name: "gulate",
        ...
        const customers = [
          {
            ...
            id_type: { code: "PHYSICAL_DNI" },
            name: "Luis Fernández",
            email: "fabian7593+lfernandez@gmail.com",
...
const packages = [
{ id: 1, specialty: { id: 2 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_PRK" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_ULTRASOUND", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 2, specialty: { id: 2 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_CT", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 3, specialty: { id: 2 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK_GUIDED" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["REGIONAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 4, specialty: { id: 1 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_STENT" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "SURGICAL_RISK_ASSESSMENT", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 5, specialty: { id: 1 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_BYPASS" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_CT", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 6, specialty: { id: 7 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_COLONOSCOPY" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PREOPERATIVE_ASSESSMENT", "POSTOP_ULTRASOUND"] }, is_king: false, observations: "", is_deleted: false },
{ id: 7, specialty: { id: 7 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_GASTROSCOPY" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PREOPERATIVE_ASSESSMENT", "POSTOP_MEDICATIONS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 8, specialty: { id: 9 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_KNEE_REPLACEMENT" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 9, specialty: { id: 9 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_ACL_SURGERY" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PREOPERATIVE_ASSESSMENT", "POSTOP_REHAB"] }, is_king: false, observations: "", is_deleted: false },
{ id: 10, specialty: { id: 9 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_ROTATOR_CUFF" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 11, specialty: { id: 9 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_SHOULDER_DISLOCATION" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 15, specialty: { id: 10 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MONOFOCAL" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_APPOINTMENT", "POSTOP_MEDICAL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 16, specialty: { id: 10 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MULTIFOCAL" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_APPOINTMENT", "POSTOP_MEDICAL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 17, specialty: { id: 10 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_PRK" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_APPOINTMENT", "POSTOP_MEDICAL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 18, specialty: { id: 10 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_APPOINTMENT", "POSTOP_MEDICAL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 19, specialty: { id: 10 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK_GUIDED" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },

{ id: 20, specialty: { id: 3 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "VAGUS_NERVE_STIMULATION" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ANESTHESIA", "SURGICAL_RISK_ASSESSMENT", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 21, specialty: { id: 4 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_DUAL" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "VITAL_MONITORS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 22, specialty: { id: 5 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_GASTROSCOPY" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "IV_FLUIDS", "POSTOP_ULTRASOUND"] }, is_king: false, observations: "", is_deleted: false },
{ id: 23, specialty: { id: 6 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_COLONOSCOPY" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "PRE_SURGERY_LAB_TESTS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 24, specialty: { id: 8 }, procedure: { code: "GASTRO_ULCER_TREATMENT" }, product: { code: "GASTRO_PPI_THERAPY" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },

{ id: 25, specialty: { id: 11 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_STENT" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "SURGICAL_RISK_ASSESSMENT", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 26, specialty: { id: 12 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_ROTATOR_CUFF" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 27, specialty: { id: 13 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MONOFOCAL" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 28, specialty: { id: 14 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_ACL_SURGERY" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "GENERAL_ANESTHESIA", "POSTOP_REHAB"] }, is_king: false, observations: "", is_deleted: false },
{ id: 29, specialty: { id: 15 }, procedure: { code: "PARKINSON_TREATMENT" }, product: { code: "DEEP_BRAIN_STIMULATION" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "GENERAL_ANESTHESIA", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },

{ id: 30, specialty: { id: 16 }, procedure: { code: "INFERTILITY_TREATMENT" }, product: { code: "IVF" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "PRE_SURGERY_LAB_TESTS", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 31, specialty: { id: 17 }, procedure: { code: "ENDOMETRIOSIS_SURGERY" }, product: { code: "ENDOMETRIOSIS_LAPAROSCOPY" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "STERILE_SURGICAL_EQUIPMENT", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 32, specialty: { id: 18 }, procedure: { code: "BREAST_CANCER_TREATMENT" }, product: { code: "MASTECTOMY_RADICAL" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_ANTIBIOTICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 33, specialty: { id: 19 }, procedure: { code: "LUNG_CANCER_TREATMENT" }, product: { code: "LUNG_TARGETED_THERAPY" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 34, specialty: { id: 20 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_SINGLE" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "GENERAL_ANESTHESIA", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },

{ id: 35, specialty: { id: 21 }, procedure: { code: "GASTRO_ULCER_TREATMENT" }, product: { code: "GASTRO_H_PYLORI" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_MEDICATIONS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 36, specialty: { id: 22 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_FEMOTOLASIK" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_ULTRASOUND", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 37, specialty: { id: 23 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_KNEE_REPLACEMENT" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 38, specialty: { id: 24 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_CATH" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "IV_FLUIDS", "POSTOP_ULTRASOUND"] }, is_king: false, observations: "", is_deleted: false },
{ id: 39, specialty: { id: 25 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "EPILEPSY_SURGERY" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },

{ id: 40, specialty: { id: 26 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_BYPASS" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 41, specialty: { id: 27 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_DUAL" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 42, specialty: { id: 28 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_COLONOSCOPY" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "IV_FLUIDS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 43, specialty: { id: 29 }, procedure: { code: "GASTRO_ULCER_TREATMENT" }, product: { code: "GASTRO_H_PYLORI" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_MEDICATIONS", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 44, specialty: { id: 30 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_KNEE_REPLACEMENT" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },

{ id: 45, specialty: { id: 31 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_SHOULDER_DISLOCATION" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_REHAB"] }, is_king: false, observations: "", is_deleted: false },
{ id: 46, specialty: { id: 32 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["REGIONAL_ANESTHESIA", "POSTOP_ULTRASOUND", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 47, specialty: { id: 33 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_FEMOTOLASIK" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_CT", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 48, specialty: { id: 34 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MULTIFOCAL" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 49, specialty: { id: 35 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "VAGUS_NERVE_STIMULATION" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "GENERAL_ANESTHESIA", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },

{ id: 50, specialty: { id: 36 }, procedure: { code: "PARKINSON_TREATMENT" }, product: { code: "DOPAMINE_THERAPY" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 51, specialty: { id: 37 }, procedure: { code: "ENDOMETRIOSIS_SURGERY" }, product: { code: "ENDOMETRIOSIS_RESECTION" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "STERILE_SURGICAL_EQUIPMENT", "POSTOP_ANTIBIOTICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 52, specialty: { id: 38 }, procedure: { code: "INFERTILITY_TREATMENT" }, product: { code: "ARTIFICIAL_INSEMINATION" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "PRE_SURGERY_LAB_TESTS", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 53, specialty: { id: 39 }, procedure: { code: "BREAST_CANCER_TREATMENT" }, product: { code: "BREAST_CONSERVATIVE_SURGERY" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_ANTICOAGULANTS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 54, specialty: { id: 40 }, procedure: { code: "LUNG_CANCER_TREATMENT" }, product: { code: "LUNG_RESECTION" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "VITAL_MONITORS", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },

{ id: 55, specialty: { id: 41 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_CATH" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "IV_FLUIDS", "POSTOP_ULTRASOUND"] }, is_king: false, observations: "", is_deleted: false },
{ id: 56, specialty: { id: 42 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_SINGLE" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "GENERAL_ANESTHESIA", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 57, specialty: { id: 43 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_GASTROSCOPY" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "PRE_SURGERY_LAB_TESTS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 58, specialty: { id: 44 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_ACL_SURGERY" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 59, specialty: { id: 45 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK_GUIDED" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["REGIONAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },

{ id: 60, specialty: { id: 46 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_STENT" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "SURGICAL_RISK_ASSESSMENT", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 61, specialty: { id: 47 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_SINGLE" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 62, specialty: { id: 48 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_COLONOSCOPY" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "IV_FLUIDS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 63, specialty: { id: 49 }, procedure: { code: "GASTRO_ULCER_TREATMENT" }, product: { code: "GASTRO_PPI_THERAPY" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 64, specialty: { id: 50 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_ACL_SURGERY" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 65, specialty: { id: 51 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_ROTATOR_CUFF" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 66, specialty: { id: 52 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_PRK" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["REGIONAL_ANESTHESIA", "POSTOP_ULTRASOUND", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 67, specialty: { id: 53 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MONOFOCAL" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 68, specialty: { id: 54 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "EPILEPSY_SURGERY" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "GENERAL_ANESTHESIA", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 69, specialty: { id: 55 }, procedure: { code: "PARKINSON_TREATMENT" }, product: { code: "DEEP_BRAIN_STIMULATION" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ANESTHESIA", "VITAL_MONITORS", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 70, specialty: { id: 56 }, procedure: { code: "ENDOMETRIOSIS_SURGERY" }, product: { code: "ENDOMETRIOSIS_LAPAROSCOPY" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "STERILE_SURGICAL_EQUIPMENT", "POSTOP_ANTIBIOTICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 71, specialty: { id: 57 }, procedure: { code: "INFERTILITY_TREATMENT" }, product: { code: "IVF" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "PRE_SURGERY_LAB_TESTS", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 72, specialty: { id: 58 }, procedure: { code: "BREAST_CANCER_TREATMENT" }, product: { code: "MASTECTOMY_RADICAL" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_ANTICOAGULANTS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 73, specialty: { id: 59 }, procedure: { code: "LUNG_CANCER_TREATMENT" }, product: { code: "LUNG_TARGETED_THERAPY" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_CT", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 74, specialty: { id: 60 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_BYPASS" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 75, specialty: { id: 61 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_DUAL" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 76, specialty: { id: 62 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_GASTROSCOPY" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "IV_FLUIDS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 77, specialty: { id: 63 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_KNEE_REPLACEMENT" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 78, specialty: { id: 64 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_FEMOTOLASIK" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_CT", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 79, specialty: { id: 65 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MULTIFOCAL" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },

{ id: 80, specialty: { id: 66 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_CATH" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "SURGICAL_RISK_ASSESSMENT", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 81, specialty: { id: 67 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_SINGLE" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 82, specialty: { id: 68 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_COLONOSCOPY" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "IV_FLUIDS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 83, specialty: { id: 69 }, procedure: { code: "GASTRO_ULCER_TREATMENT" }, product: { code: "GASTRO_H_PYLORI" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 84, specialty: { id: 70 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_KNEE_REPLACEMENT" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 85, specialty: { id: 71 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_SHOULDER_DISLOCATION" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 86, specialty: { id: 72 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["REGIONAL_ANESTHESIA", "POSTOP_ULTRASOUND", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 87, specialty: { id: 73 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK_GUIDED" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_CT", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 88, specialty: { id: 74 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MONOFOCAL" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 89, specialty: { id: 75 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MULTIFOCAL" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 90, specialty: { id: 76 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "VAGUS_NERVE_STIMULATION" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ANESTHESIA", "GENERAL_ANESTHESIA", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 91, specialty: { id: 77 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "EPILEPSY_SURGERY" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 92, specialty: { id: 78 }, procedure: { code: "PARKINSON_TREATMENT" }, product: { code: "DEEP_BRAIN_STIMULATION" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ANESTHESIA", "VITAL_MONITORS", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 93, specialty: { id: 79 }, procedure: { code: "PARKINSON_TREATMENT" }, product: { code: "DOPAMINE_THERAPY" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 94, specialty: { id: 80 }, procedure: { code: "ENDOMETRIOSIS_SURGERY" }, product: { code: "ENDOMETRIOSIS_LAPAROSCOPY" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "STERILE_SURGICAL_EQUIPMENT", "POSTOP_ANTIBIOTICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 95, specialty: { id: 81 }, procedure: { code: "ENDOMETRIOSIS_SURGERY" }, product: { code: "ENDOMETRIOSIS_RESECTION" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "SURGICAL_SUTURES", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 96, specialty: { id: 82 }, procedure: { code: "INFERTILITY_TREATMENT" }, product: { code: "IVF" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "GENERAL_PRE_SURGERY_EVAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 97, specialty: { id: 83 }, procedure: { code: "INFERTILITY_TREATMENT" }, product: { code: "ARTIFICIAL_INSEMINATION" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 98, specialty: { id: 84 }, procedure: { code: "BREAST_CANCER_TREATMENT" }, product: { code: "MASTECTOMY_RADICAL" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_ANTICOAGULANTS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 99, specialty: { id: 85 }, procedure: { code: "BREAST_CANCER_TREATMENT" }, product: { code: "BREAST_CONSERVATIVE_SURGERY" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_ANTIBIOTICS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 100, specialty: { id: 86 }, procedure: { code: "LUNG_CANCER_TREATMENT" }, product: { code: "LUNG_RESECTION" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 101, specialty: { id: 87 }, procedure: { code: "LUNG_CANCER_TREATMENT" }, product: { code: "LUNG_TARGETED_THERAPY" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_CT", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 102, specialty: { id: 88 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_STENT" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "SURGICAL_RISK_ASSESSMENT", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 103, specialty: { id: 89 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_BYPASS" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 104, specialty: { id: 90 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_DUAL" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 105, specialty: { id: 91 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_GASTROSCOPY" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "IV_FLUIDS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 106, specialty: { id: 92 }, procedure: { code: "GASTRO_ULCER_TREATMENT" }, product: { code: "GASTRO_PPI_THERAPY" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 107, specialty: { id: 93 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_ACL_SURGERY" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 108, specialty: { id: 94 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_ROTATOR_CUFF" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 109, specialty: { id: 95 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_PRK" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["REGIONAL_ANESTHESIA", "POSTOP_ULTRASOUND", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 110, specialty: { id: 96 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_FEMOTOLASIK" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_CT", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 111, specialty: { id: 97 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MONOFOCAL" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 112, specialty: { id: 98 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "VAGUS_NERVE_STIMULATION" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ANESTHESIA", "GENERAL_ANESTHESIA", "POSTOP_PAIN_CONTROL"] }, is_king: false, observations: "", is_deleted: false },
{ id: 113, specialty: { id: 99 }, procedure: { code: "PARKINSON_TREATMENT" }, product: { code: "DEEP_BRAIN_STIMULATION" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ANESTHESIA", "VITAL_MONITORS", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 114, specialty: { id: 100 }, procedure: { code: "ENDOMETRIOSIS_SURGERY" }, product: { code: "ENDOMETRIOSIS_LAPAROSCOPY" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "STERILE_SURGICAL_EQUIPMENT", "POSTOP_ANTIBIOTICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 115, specialty: { id: 101 }, procedure: { code: "INFERTILITY_TREATMENT" }, product: { code: "IVF" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "GENERAL_PRE_SURGERY_EVAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 116, specialty: { id: 102 }, procedure: { code: "BREAST_CANCER_TREATMENT" }, product: { code: "BREAST_CONSERVATIVE_SURGERY" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_ANTIBIOTICS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 117, specialty: { id: 103 }, procedure: { code: "LUNG_CANCER_TREATMENT" }, product: { code: "LUNG_TARGETED_THERAPY" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "POSTOP_CT", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 118, specialty: { id: 104 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_STENT" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "SURGICAL_RISK_ASSESSMENT", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 119, specialty: { id: 105 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "PACEMAKER_DUAL" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_SURGEON_FOLLOWUP"] }, is_king: false, observations: "", is_deleted: false },
{ id: 120, specialty: { id: 106 }, procedure: { code: "GASTRO_ENDOSCOPY" }, product: { code: "GASTRO_COLONOSCOPY" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_PRE_SURGERY_EVAL", "IV_FLUIDS", "POSTOP_ANALGESICS"] }, is_king: false, observations: "", is_deleted: false },
{ id: 121, specialty: { id: 107 }, procedure: { code: "GASTRO_ULCER_TREATMENT" }, product: { code: "GASTRO_H_PYLORI" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 122, specialty: { id: 108 }, procedure: { code: "ORTHO_KNEE_SURGERY" }, product: { code: "ORTHO_KNEE_REPLACEMENT" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_REHAB", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 123, specialty: { id: 109 }, procedure: { code: "ORTHO_SHOULDER_SURGERY" }, product: { code: "ORTHO_ROTATOR_CUFF" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["GENERAL_ANESTHESIA", "POSTOP_XRAY", "POSTOP_PHYSIOTHERAPY"] }, is_king: false, observations: "", is_deleted: false },
{ id: 124, specialty: { id: 110 }, procedure: { code: "REFRACTIVE_SURGERY" }, product: { code: "REFRACTIVE_LASIK" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["REGIONAL_ANESTHESIA", "POSTOP_ULTRASOUND", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 125, specialty: { id: 111 }, procedure: { code: "CATARACT_SURGERY" }, product: { code: "LIO_MULTIFOCAL" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["MEDICAL_SPENDING", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 126, specialty: { id: 112 }, procedure: { code: "EPILEPSY_TREATMENT" }, product: { code: "EPILEPSY_SURGERY" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_ECG", "VITAL_MONITORS", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 127, specialty: { id: 113 }, procedure: { code: "INFERTILITY_TREATMENT" }, product: { code: "ARTIFICIAL_INSEMINATION" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["PRE_SURGERY_LAB_TESTS", "POSTOP_MEDICAL", "POSTOP_APPOINTMENT"] }, is_king: false, observations: "", is_deleted: false },
{ id: 128, specialty: { id: 114 }, procedure: { code: "LUNG_CANCER_TREATMENT" }, product: { code: "LUNG_RESECTION" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: ["SURGICAL_RISK_ASSESSMENT", "GENERAL_ANESTHESIA", "POSTOP_CT"] }, is_king: false, observations: "", is_deleted: false },

// -----------------------------
// NEW Packages (Cardiology) - add new cardiology procedures/products (codes intact)
// -----------------------------
{ id: 129, specialty: { id: 11 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_ANGIOPLASTY" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 130, specialty: { id: 11 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_PERCUTANEOUS_VALVES" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 131, specialty: { id: 11 }, procedure: { code: "CARDIO_INTERVENTION" }, product: { code: "CARDIO_CATH_COMPREHENSIVE" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 132, specialty: { id: 11 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "CARDIO_PACEMAKER_IMPLANT_CONTROL" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 133, specialty: { id: 11 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "CARDIO_PACEMAKER_GENERATOR_CHANGE" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 134, specialty: { id: 11 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "CARDIO_PACEMAKER_LEAD_EXTRACTION" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 135, specialty: { id: 11 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "CARDIO_ICD_IMPLANT" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 136, specialty: { id: 11 }, procedure: { code: "PACEMAKER_IMPLANT" }, product: { code: "CARDIO_CRT_IMPLANT" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },

{ id: 137, specialty: { id: 11 }, procedure: { code: "CARDIO_ECHO_TTE_REST" }, product: { code: "CARDIO_ECHO_TTE_REST_TEST" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 138, specialty: { id: 11 }, procedure: { code: "CARDIO_ECHO_TEE" }, product: { code: "CARDIO_ECHO_TEE_TEST" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 139, specialty: { id: 11 }, procedure: { code: "CARDIO_ECHO_STRESS_EXERCISE" }, product: { code: "CARDIO_ECHO_STRESS_EXERCISE_TEST" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 140, specialty: { id: 11 }, procedure: { code: "CARDIO_ECHO_STRESS_DOBUTAMINE" }, product: { code: "CARDIO_ECHO_STRESS_DOBUTAMINE_TEST" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 141, specialty: { id: 11 }, procedure: { code: "CARDIO_ECG_INTERPRETATION" }, product: { code: "CARDIO_ECG_INTERPRETATION_TEST" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 142, specialty: { id: 11 }, procedure: { code: "CARDIO_ECG_STRESS" }, product: { code: "CARDIO_ECG_STRESS_TEST" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 143, specialty: { id: 11 }, procedure: { code: "CARDIO_STRESS_TEST" }, product: { code: "CARDIO_STRESS_TEST_STD" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 144, specialty: { id: 11 }, procedure: { code: "CARDIO_ARRHYTHMIA_ABLATION" }, product: { code: "CARDIO_ARRHYTHMIA_ABLATION_PROC" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 145, specialty: { id: 11 }, procedure: { code: "CARDIO_HOLTER" }, product: { code: "CARDIO_HOLTER_24_48" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 146, specialty: { id: 11 }, procedure: { code: "CARDIO_EVENT_MONITOR" }, product: { code: "CARDIO_EVENT_MONITOR_STD" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 147, specialty: { id: 11 }, procedure: { code: "CARDIO_ABPM_MAPA" }, product: { code: "CARDIO_ABPM_MAPA_24" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 148, specialty: { id: 11 }, procedure: { code: "CARDIO_BP_MONITORING" }, product: { code: "CARDIO_BP_MONITORING_VISIT" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 149, specialty: { id: 11 }, procedure: { code: "CARDIO_CT_CORONARY_ANGIO" }, product: { code: "CARDIO_CT_CORONARY_ANGIO_TEST" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 150, specialty: { id: 11 }, procedure: { code: "CARDIO_PERICARDIOCENTESIS" }, product: { code: "CARDIO_PERICARDIOCENTESIS_PROC" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 151, specialty: { id: 11 }, procedure: { code: "CARDIO_SPIROMETRY" }, product: { code: "CARDIO_SPIROMETRY_TEST" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 152, specialty: { id: 11 }, procedure: { code: "CARDIO_PREOP_EVALUATION" }, product: { code: "CARDIO_PREOP_EVALUATION_PACKAGE" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 153, specialty: { id: 11 }, procedure: { code: "CARDIO_VIDEO_CONSULT" }, product: { code: "CARDIO_VIDEO_CONSULT_VISIT" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },





{ id: 182, specialty: { id: 64 }, procedure: { code: "CARDIO_ECG_INTERPRETATION" }, product: { code: "CARDIO_ECG_INTERPRETATION_TEST" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 183, specialty: { id: 64 }, procedure: { code: "CARDIO_ECG_STRESS" }, product: { code: "CARDIO_ECG_STRESS_TEST" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 184, specialty: { id: 64 }, procedure: { code: "CARDIO_STRESS_TEST" }, product: { code: "CARDIO_STRESS_TEST_STD" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 185, specialty: { id: 64 }, procedure: { code: "CARDIO_ARRHYTHMIA_ABLATION" }, product: { code: "CARDIO_ARRHYTHMIA_ABLATION_PROC" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 186, specialty: { id: 64 }, procedure: { code: "CARDIO_HOLTER" }, product: { code: "CARDIO_HOLTER_24_48" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 187, specialty: { id: 64 }, procedure: { code: "CARDIO_EVENT_MONITOR" }, product: { code: "CARDIO_EVENT_MONITOR_STD" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 188, specialty: { id: 64 }, procedure: { code: "CARDIO_ABPM_MAPA" }, product: { code: "CARDIO_ABPM_MAPA_24" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 189, specialty: { id: 64 }, procedure: { code: "CARDIO_BP_MONITORING" }, product: { code: "CARDIO_BP_MONITORING_VISIT" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 190, specialty: { id: 64 }, procedure: { code: "CARDIO_CT_CORONARY_ANGIO" }, product: { code: "CARDIO_CT_CORONARY_ANGIO_TEST" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 191, specialty: { id: 64 }, procedure: { code: "CARDIO_PERICARDIOCENTESIS" }, product: { code: "CARDIO_PERICARDIOCENTESIS_PROC" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 192, specialty: { id: 64 }, procedure: { code: "CARDIO_SPIROMETRY" }, product: { code: "CARDIO_SPIROMETRY_TEST" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 193, specialty: { id: 64 }, procedure: { code: "CARDIO_PREOP_EVALUATION" }, product: { code: "CARDIO_PREOP_EVALUATION_PACKAGE" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 194, specialty: { id: 64 }, procedure: { code: "CARDIO_VIDEO_CONSULT" }, product: { code: "CARDIO_VIDEO_CONSULT_VISIT" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },

// -----------------------------
// FIXED Packages (Ophthalmology) - using existing ProceduresAndProducts codes
// -----------------------------
{ id: 154, specialty: { id: 34 }, procedure: { code: "OPHTH_PTERYGIUM_SURGERY" }, product: { code: "OPHTH_PTERYGIUM_STD" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 155, specialty: { id: 34 }, procedure: { code: "OPHTH_KERATOCONUS_SURGERY" }, product: { code: "OPHTH_CXL" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 156, specialty: { id: 34 }, procedure: { code: "OPHTH_CONSULTATION" }, product: { code: "OPHTH_CONSULTATION_GENERAL" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 157, specialty: { id: 34 }, procedure: { code: "OPHTH_BLEPHAROPLASTY" }, product: { code: "OPHTH_BLEPHAROPLASTY_STD" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 158, specialty: { id: 34 }, procedure: { code: "OPHTH_CAPSULOTOMY" }, product: { code: "OPHTH_CAPSULOTOMY_YAG" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },

// Glaucoma: procedure = OPHTH_GLAUCOMA_SURGERY, products are its children
{ id: 161, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_AHMED_VALVE" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 166, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_PHACO_AHMED" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 167, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_PHACOTRABECULECTOMY" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 168, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_LASER_IRIDOTOMY" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 169, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_ANGLE_STUDY" }, discount: 16000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 173, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_IRIDOTOMY" }, discount: 11000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 177, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_TRABECULECTOMY" }, discount: 19000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 178, specialty: { id: 34 }, procedure: { code: "OPHTH_GLAUCOMA_SURGERY" }, product: { code: "OPHTH_SLTP" }, discount: 13000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },

// Lacrimal: procedure = OPHTH_LACRIMAL_SURGERY, products are its children
{ id: 164, specialty: { id: 34 }, procedure: { code: "OPHTH_LACRIMAL_SURGERY" }, product: { code: "OPHTH_LACRIMAL_OBSTRUCTION_SURGERY" }, discount: 21000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 171, specialty: { id: 34 }, procedure: { code: "OPHTH_LACRIMAL_SURGERY" }, product: { code: "OPHTH_LACRIMAL_INTUBATION" }, discount: 17000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 174, specialty: { id: 34 }, procedure: { code: "OPHTH_LACRIMAL_SURGERY" }, product: { code: "OPHTH_PUNCTAL_PLASTY" }, discount: 10500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 163, specialty: { id: 34 }, procedure: { code: "OPHTH_CHALAZION_CURETTAGE" }, product: { code: "OPHTH_CHALAZION_CURETTAGE_STD" }, discount: 20500, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 165, specialty: { id: 34 }, procedure: { code: "OPHTH_RETINAL_DIATHERMY" }, product: { code: "OPHTH_RETINAL_DIATHERMY_STD" }, discount: 12000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 172, specialty: { id: 34 }, procedure: { code: "OPHTH_INTRAOCULAR_INJECTION" }, product: { code: "OPHTH_INTRAOCULAR_INJECTION_STD" }, discount: 15000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },

// Lens: procedure = OPHTH_LENS_PROCEDURE, products are its children
{ id: 170, specialty: { id: 34 }, procedure: { code: "OPHTH_LENS_PROCEDURE" }, product: { code: "OPHTH_LENS_IMPLANT" }, discount: 18000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 176, specialty: { id: 34 }, procedure: { code: "OPHTH_LENS_PROCEDURE" }, product: { code: "OPHTH_IOL_REMOVAL" }, discount: 20000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 175, specialty: { id: 34 }, procedure: { code: "OPHTH_CORNEAL_SCRAPING" }, product: { code: "OPHTH_CORNEAL_SCRAPING_STD" }, discount: 10000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 179, specialty: { id: 34 }, procedure: { code: "OPHTH_CORNEAL_TRANSPLANT" }, product: { code: "OPHTH_CORNEAL_TRANSPLANT_STD" }, discount: 22000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },
{ id: 180, specialty: { id: 34 }, procedure: { code: "OPHTH_OCULAR_ULTRASOUND" }, product: { code: "OPHTH_OCULAR_ULTRASOUND_BSCAN" }, discount: 14000, postoperative_assessments: null, services_offer: { ASSESSMENT_DETAILS: [] }, is_king: false, observations: "", is_deleted: false },

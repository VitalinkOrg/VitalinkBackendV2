...
async function runSeed() {
    ...
    */
    ...
    const MedicalSpecialties = [
        { name: "Odontología", code: "ODONTOLOGY", type: "ODONTOLOGY_SPECIALTY", father_code: "ODONTOLOGY_MEDICAL" },
        { name: "Acupuntura", code: "ACUPUNCTURE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Administración de Servicios de Salud", code: "HEALTH_SERVICES_ADMINISTRATION", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Alergología", code: "ALLERGOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Anatomía Patológica", code: "PATHOLOGICAL_ANATOMY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Anestesiología y Recuperación", code: "ANESTHESIOLOGY_AND_RECOVERY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Cardiología", code: "CARDIOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Cirugía General", code: "GENERAL_SURGERY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Cuidados Paliativos en Adultos", code: "ADULT_PALLIATIVE_CARE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Dermatología", code: "DERMATOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Endocrinología", code: "ENDOCRINOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Gastroenterología", code: "GASTROENTEROLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Geriatría y Gerontología", code: "GERIATRICS_AND_GERONTOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Ginecología y Obstetricia", code: "GYNECOLOGY_AND_OBSTETRICS", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Hematología", code: "HEMATOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Infectología", code: "INFECTOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina Aeroespacial", code: "AEROSPACE_MEDICINE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina Crítica y Terapia Intensiva", code: "CRITICAL_CARE_AND_INTENSIVE_THERAPY", type: "MEDICAL_SPECIALTY", father_code:"SPECIALTY_MEDICAL" },
        { name: "Medicina de Emergencias", code:"EMERGENCY_MEDICINE" , type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Medicina del Deporte", code: "SPORTS_MEDICINE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina del Trabajo", code: "OCCUPATIONAL_MEDICINE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina Familiar y Comunitaria", code: "FAMILY_AND_COMMUNITY_MEDICINE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina Física y Rehabilitación", code: "PHYSICAL_MEDICINE_AND_REHABILITATION", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina Hiperbárica", code: "HYPERBARIC_MEDICINE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina Interna", code: "INTERNAL_MEDICINE", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Medicina Legal", code: "LEGAL_MEDICINE", type: "MEDICAL_SPECIALTY", father_code:"SPECIALTY_MEDICAL"},
        { name: "Medicina Nuclear", code:"NUCLEAR_MEDICINE" , type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Medicina Preventiva y Salud Pública", code:"PREVENTIVE_MEDICINE_AND_PUBLIC_HEALTH" , type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Neumología", code:"PULMONOLOGY" , type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Neurología", code: "NEUROLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Nutriología Clínica", code: "CLINICAL_NUTRITION", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Oftalmología", code: "OPHTHALMOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Oncología Médica", code: "MEDICAL_ONCOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Oncología Quirúrgica", code: "SURGICAL_ONCOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Oncología Radioterápica", code: "RADIATION_ONCOLOGY", type: "MEDICAL_SPECIALTY", father_code:"SPECIALTY_MEDICAL"},
        { name: "Ortopedia y Traumatología", code: "ORTHOPEDICS_AND_TRAUMATOLOGY", type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Otorrinolaringología", code:"OTORHINOLARYNGOLOGY" , type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Pediatría", code:"PEDIATRICS" , type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Psiquiatría", code:"PSYCHIATRY" , type:"MEDICAL_SPECIALTY" , father_code:"SPECIALTY_MEDICAL"},
        { name: "Radiología e Imágenes Médicas", code: "RADIOLOGY_AND_MEDICAL_IMAGING", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Radioterapia", code: "RADIOTHERAPY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Reumatología", code: "RHEUMATOLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" },
        { name: "Urología", code: "UROLOGY", type: "MEDICAL_SPECIALTY", father_code: "SPECIALTY_MEDICAL" }
    ];
...
{ name: "Videoconsulta cardiología", code: "CARDIO_VIDEO_CONSULT_VISIT", type: "MEDICAL_PRODUCT", father_code: "CARDIO_VIDEO_CONSULT", value1: "55000", description: "Consulta por videollamada con orientación clínica y plan de manejo (según alcance del servicio)." }, // 49 (PRODUCT - Videoconsulta)
    ...
    const notifications = [
    {
        ...
        action_url: "https://vitalkink.cr/medicos/citas",
    ...
    },
    {
        ...
        action_url: "https://vitalkink.cr/pacientes/citas",
        action_text: "Mis Citas Vitalink",
        language: "es",
    },
    {
